...
module.exports = function (callback) {
    ...
    EcommerceStore.deployed().then(function (i) { i.addProductToStore('iphone 5', 'Cell Phones & Accessories', 'Qma22nntN8pDskbu8vCFPcZahf2jPiyzwjo74vtS6dTCfr', 'QmWsXfZEMMeAEFt8rmedeCDU6qcagCWXM8wzReYehmoZbN', current_time, current_time + 20, web3.utils.toWei('2', 'ether'), 0).then(function (f) { console.log(f) }) });
